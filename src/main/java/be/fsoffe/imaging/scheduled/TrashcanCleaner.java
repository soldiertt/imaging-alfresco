...
public class TrashcanCleaner {
	 ...
	 * @param daysToKeep
	 */
	public TrashcanCleaner(NodeService nodeService, int deleteBatchCount, int daysToKeep) {
		this(nodeService);
	 ...
	 * @param daysToKeep
	 */
	public TrashcanCleaner(NodeService nodeService, String archiveStoreUrl, int deleteBatchCount, int daysToKeep) {
	...
	private boolean olderThanDaysToKeep(NodeRef node) {
		...
		return daysToKeep * DAYS_TO_MILLIS < System.currentTimeMillis() - archivedDateValue;
	}
}
